...
import { Card, CardContent, Box, TextField, Checkbox, FormControlLabel, Select, MenuItem, IconButton, Tooltip, Typography, RadioGroup, Radio, Button } from '@mui/material';
...
function InputBuilderBlock({ blockId, block, index, orderLength, level, indexPath, idPath, onMove, onDelete }) {
  ...
  switch (info.type) {
    ...
    // 'date' case removed as it requires an external date picker library not provided
    default:
      field = (
        <TextField
          size="small"
